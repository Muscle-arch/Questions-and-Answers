        ...
        <div class="auth-card" :class="{ shake: isError }">
            ...
            <el-form ref="formRef" :model="form" :rules="rules" label-position="top" @submit.prevent="handleRegister">
                ...
                <el-form-item prop="confirmPassword" label="确认密码">
                    <div class="input-wrapper" :class="{ focused: focusedField === 'confirmPassword', filled: form.confirmPassword }">
                        <div class="input-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <button class="submit-btn" :class="{ loading: loading }" :disabled="loading" @click="handleRegister">
            ...
            <div class="auth-footer">
                <span>已有账号？</span>
                <el-link type="primary" @click="router.push('/login')" class="register-link">
                    立即登录
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
.bg-gradient {
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at 70% 30%, rgba(200,149,108,0.15) 0%, transparent 50%),
                radial-gradient(circle at 30% 70%, rgba(155,27,48,0.2) 0%, transparent 50%);
